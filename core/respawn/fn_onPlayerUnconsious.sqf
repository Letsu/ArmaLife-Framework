...
if _state then {
	...
	_reqNoMedic ctrlAddEventHandler ["ButtonClick", "closeDialog 0"];
...
//	_reqMedic ctrlAddEventHandler ["ButtonClick", "[] spawn life_fnc_requestMedic; closeDialog 0"]; <--- Nedd Function to create an Emergeny by the 911
} else {
	closeDialog 0;
};
